...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: #45526e; height:70px">
    ...
    <h1 class="text-center fw-bold" style="margin-top: 5%; ">ADD COMPANY</h1>

    <div class="container ">
      <div class="row shadow-lg p-2">
        <div class="col-md-5 mt-4 mb-4">
          <img src="https://fintax.pk/images/Company-Registration-1024x537-1024x520.png" height="400px" width="450px" class="rounded" alt="">
        </div>
        <div class="col-md-7">
          <form method="POST" action="/add-company">
            ...
            <div class="row">
              <div class="col">
                <label for="" class="fw-bold mb-1 mt-3">Company Name</label>
            ...
            <div class="row">
                <div class="col">
                  <label for="" class="fw-bold mb-1 mt-3">Company Address</label>
                  <textarea class="form-control" placeholder="Enter Company Address" name="address"></textarea>
                </div>
              </div>
