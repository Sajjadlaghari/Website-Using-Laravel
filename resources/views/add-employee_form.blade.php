...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: #45526e; height:70px">
    ...
    <h1 class="text-center fw-bold" style="margin-top: 5%; ">Add Employee</h1>
          ...
          <form method="POST" action="/add-employee">
            ...
            <div class="row">
              <div class="col">
                ...
                <input type="text" class="form-control" value="{{old('name')}}" placeholder="Enter Employee Name" name="name">
              ...
              <div class="col">
                ...
                <input type="email" class="form-control" value="{{old('email')}}" placeholder="Enter Employee Email" name="email">
                <span class="text-danger">
                  @error('email')
                  {{$message}}
                  @enderror
            ...
            <div class="row">
              <div class="col">
                <label for="" class="fw-bold mb-1 mt-3">Select Company</label><br>
            ...
            <div class="row">
              <div class="col">
                ...
                <input type="text" class="form-control" value="{{old('number')}}" placeholder="Enter Employee Number" name="number">
                <span class="text-danger">
                  @error('number')
                  {{$message}}
                  @enderror
            ...
            <div class="row">
              <div class="col">
                <label for="" class="fw-bold mb-1 mt-3">Employee Address</label>
                <textarea class="form-control" placeholder="Enter Employee Address" name="address">{{old('address')}}</textarea>
                <span class="text-danger">
                  @error('address')
                  {{$message}}
                  @enderror
