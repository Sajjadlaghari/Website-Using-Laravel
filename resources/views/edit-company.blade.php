...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: #45526e; height:70px"">
      ...
      <h1 class="text-center fw-bold" style="margin-top: 5%; ">Update Company</h1>
    ...
    <div class="container ">
      <div class="row shadow-lg p-2">
        ...
        <div class="col-md-7">
          <form method="POST" action="/update-company/{{$company->company_id}}">
            @csrf
            <div class="row">
              <div class="col">
            ...
            <div class="row">
              <div class="col">
                ...
                <textarea class="form-control" name="address">{{$company->company_address}}</textarea>
              </div>
            </div>
